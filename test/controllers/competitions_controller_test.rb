...
class CompetitionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create competition" do
    assert_difference('Competition.count') do
      post competitions_url, params: { competition: { dataEnd: @competition.dataEnd, dateStart: @competition.dateStart, name: @competition.name, prize: @competition.prize, url: @competition.url } }
    end
  ...
  test "should update competition" do
    patch competition_url(@competition), params: { competition: { dataEnd: @competition.dataEnd, dateStart: @competition.dateStart, name: @competition.name, prize: @competition.prize, url: @competition.url } }
